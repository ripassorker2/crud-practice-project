...
const CHeekOut = () => {
  ...
  const total = parseFloat(spot.price) + 10;
  ...
  const handleSubmitProcess = (event) => {
    ...
    fetch("https://crud-server-ten.vercel.app/orders", {
      method: "POST",
      headers: {
              ...
              <div className="mt-8">
                <div className="flex flex-col space-y-4">
                  <div className="flex space-x-4">
                    <div>
                      <img src={spot?.photoUrl} alt="" className="w-48" />
                    </div>
                    <div>
                      <h2 className="text-lg font-bold w-full">
                        {spot?.place}
                      </h2>
                      <span className="text-red-600">Price</span> ${spot.price}
                    </div>
                    <div>
                      <svg
